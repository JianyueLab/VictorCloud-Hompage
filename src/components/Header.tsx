  ...
  return (
    <Popover>
      ...
      >
        ...
        <MobileNavLink href="https://dash.victorcloud.io">Dashboard</MobileNavLink>
      </PopoverPanel>
    </Popover>
  )
}
        ...
        <nav className="relative z-50 flex justify-between">
          <div className="flex items-center md:gap-x-12">
            <Link href="/" aria-label="Home">
              ...
              <span className="h-10 text-xl w-auto font-bold">VictorCloud</span>
            </Link>
          ...
          <div className="flex items-center gap-x-5 md:gap-x-8">
            <div className="hidden md:block">
              <NavLink href="https://dash.victorcloud.io">Dashboard</NavLink>
            </div>
            <Button
